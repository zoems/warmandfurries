...
Furry.create(name: "Luna Nightpaw",
description: "
...
Furry.create(name: "Astra Stardust",
...
Furry.create(name: "Bamboo Ironclaw",
...
Furry.create(name: "Nutty Wavecrest",
